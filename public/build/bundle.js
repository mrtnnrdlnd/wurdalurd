...
var app = (function () {
    ...
    function create_each_block_3(ctx) {
    	...
    	function input_input_handler() {
    		/*input_input_handler*/ ctx[6].call(input, /*i*/ ctx[24], /*j*/ ctx[26]);
    	}

    	function click_handler() {
    		return /*click_handler*/ ctx[7](/*i*/ ctx[24], /*j*/ ctx[26]);
    	}

    	function input_handler(...args) {
    		return /*input_handler*/ ctx[8](/*i*/ ctx[24], /*j*/ ctx[26], ...args);
    	}

    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "id", /*i*/ ctx[24].toString().concat(/*j*/ ctx[26].toString()));
    			attr_dev(input, "maxlength", "1");
    			attr_dev(input, "class", "letterbox svelte-kxi75n");
    			add_location(input, file, 191, 4, 7382);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, input, anchor);
    			set_input_value(input, /*letters*/ ctx[1][/*i*/ ctx[24]][/*j*/ ctx[26]]);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*letters*/ 2 && input.value !== /*letters*/ ctx[1][/*i*/ ctx[24]][/*j*/ ctx[26]]) {
    				set_input_value(input, /*letters*/ ctx[1][/*i*/ ctx[24]][/*j*/ ctx[26]]);
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(191:3) {#each row as letter, j}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 189, 2, 7330);
    			add_location(br, file, 200, 2, 7636);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(189:1) {#each letters as row, i}",
    		ctx
    	});
    ...
    // (204:1) {#if filteredWords && filteredWords.length > 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(span, file, 204, 2, 7706);
    			add_location(br, file, 204, 37, 7741);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(204:1) {#if filteredWords && filteredWords.length > 0}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 209, 4, 7843);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*displayedWords*/ 4 && t_value !== (t_value = /*letter*/ ctx[19] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(209:3) {#each word as letter}",
    		ctx
    	});
    ...
    // (206:2) {#each displayedWords as word}
    function create_each_block(ctx) {
    	let br;
    	let t0;
    	let div;
    	let t1;
    	let each_value_1 = /*word*/ ctx[16];
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			add_location(br, file, 206, 3, 7784);
    			attr_dev(div, "class", "row svelte-kxi75n");
    			add_location(div, file, 207, 3, 7793);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, br, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(206:2) {#each displayedWords as word}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 187, 0, 7292);
    		},
