...
var app = (function () {
    ...
    class RatedLetterTree {
        constructor() {
            this.letter = null;
            this.notInWord = null;
            this.rightPosition = null;
            this.wrongPosition = null;
        }
        set root(root) {
            this.letter = root;
    ...
    function create_each_block_3(ctx) {
    	...
    	function input_input_handler() {
    		/*input_input_handler*/ ctx[6].call(input, /*i*/ ctx[29], /*j*/ ctx[31]);
    	}

    	function click_handler() {
    		return /*click_handler*/ ctx[7](/*i*/ ctx[29], /*j*/ ctx[31]);
    	}

    	function input_handler(...args) {
    		return /*input_handler*/ ctx[8](/*i*/ ctx[29], /*j*/ ctx[31], ...args);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 395, 4, 23794);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(395:3) {#each row as letter, j}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 393, 2, 23742);
    			add_location(br, file, 404, 2, 24048);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*letters, toggleFilter, handleInput*/ 26) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(393:1) {#each letters as row, i}",
    		ctx
    	});
    ...
    // (410:1) {#if filteredWords && filteredWords.length > 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(span, file, 410, 2, 24221);
    			add_location(br, file, 410, 37, 24256);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*filteredWords*/ 1 && t0_1_value !== (t0_1_value = /*filteredWords*/ ctx[0].length + "")) set_data_dev(t0_1, t0_1_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(410:1) {#if filteredWords && filteredWords.length > 0}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 415, 4, 24358);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(415:3) {#each word as letter}",
    		ctx
    	});
    ...
    // (412:2) {#each displayedWords as word}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1_1 = space();
    			add_location(br, file, 412, 3, 24299);
    			attr_dev(div, "class", "row svelte-kxi75n");
    			add_location(div, file, 413, 3, 24308);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, br, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(412:2) {#each displayedWords as word}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 391, 0, 23704);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function benchmark(words, firstGuess) {
    		let filteredWords;
    	...
    	function ratedWords4(guessWords, possibleWords) {
    		let sortedWords = ["00000", ...guessWords.sort()];
    		let ratedWords = new Map(guessWords.map(w => [w, 0]));
    		let wordLength = sortedWords[0].length;
    		let ratedLetter = Array(wordLength + 1).fill([]).map((_, i) => Array(3 ** i).fill({ probability: -1, filteredWords: [] }));
    		...
    		for (let i = 1; i < sortedWords.length; i++) {
    			...
    			ratedWords.set(word, ratedLetter[wordLength - 1].filter(rated => rated.probability).map(rated => rated.filteredWords.length * rated.probability).reduce((p, c) => p + c));
    		} // let t1 = performance.now();
    	...
    	function ratedWords3(words, filteredWords) {
    		...
    		let ratedLetter = new RatedLetterTree();
    	...
    	function rateWordRecursive(word, words, position, probability, ratedLetter) {
    		...
    		let ratedLetterAtPosition = ratedLetter != null && ratedLetter.letter != null
    		? ratedLetter.letter
    	...
    	function rateWordsRecursive(words, index, position, probability, ratedLetter) {
    		var _a;
    		let sum = 0;

    		let ratedLetterAtPosition = (_a = ratedLetter.letter) !== null && _a !== void 0
    		? _a
    		: rateLetterAtPosition(words, words[index].charAt(position), position);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*letters, filters*/ 34) {
    			{
    		...
    		if ($$self.$$.dirty[0] & /*filteredWords*/ 1) {
    			{
    				if (filteredWords.length > 0 && filteredWords.length <= 4) {
    					$$invalidate(2, displayedWords = [...ratedWords4(filteredWords, filteredWords).keys()].slice(0, 10));
    				} else // displayedWords = words.sort();
    				if (filteredWords.length > 4) {
    					console.log(ratedWords4(words, filteredWords)); // displayedWords = [...ratedWords(filteredWords, rateAlphabet(filteredWords)).keys()].slice(0, 10)
    					$$invalidate(2, displayedWords = [...ratedWords4(words, filteredWords).keys()].slice(0, 10));
