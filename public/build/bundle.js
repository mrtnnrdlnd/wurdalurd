...
var app = (function () {
    ...
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 311, 4, 18683);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(311:3) {#each row as letter, j}",
    		ctx
    	});
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 309, 2, 18631);
    			add_location(br, file, 320, 2, 18937);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(309:1) {#each letters as row, i}",
    		ctx
    	});
    ...
    // (326:1) {#if filteredWords && filteredWords.length > 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(span, file, 326, 2, 19110);
    			add_location(br, file, 326, 37, 19145);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(326:1) {#if filteredWords && filteredWords.length > 0}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 331, 4, 19247);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(331:3) {#each word as letter}",
    		ctx
    	});
    ...
    // (328:2) {#each displayedWords as word}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			add_location(br, file, 328, 3, 19188);
    			attr_dev(div, "class", "row svelte-kxi75n");
    			add_location(div, file, 329, 3, 19197);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, br, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(328:2) {#each displayedWords as word}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 307, 0, 18593);
    		},
